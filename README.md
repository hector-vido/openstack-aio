...
openstack flavor create --vcpus 4 --ram $((1024*16)) --disk 120 4cpu-16gb
openstack flavor create --vcpus 2 --ram $((1024*8)) --disk 120 2cpu-8gb
...
openstack quota set --ram $((1024*96)) --default 
```
### From outside
